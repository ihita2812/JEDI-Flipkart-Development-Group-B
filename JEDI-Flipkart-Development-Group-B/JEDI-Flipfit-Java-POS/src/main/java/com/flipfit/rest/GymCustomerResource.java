...
public class GymCustomerResource {
    ...
    public List<GymCenter> viewApprovedGyms() {
        System.out.println("GET /customer/gyms endpoint was hit!");
    ...
    public List<Slot> viewSlotsForGym(@PathParam("gymId") int gymId) {
        System.out.println("GET /customer/gyms/" + gymId + "/slots endpoint was hit!");
    ...
    public List<Booking> viewMyBookings(@PathParam("customerId") int customerId) {
        System.out.println("GET /customer/" + customerId + "/bookings endpoint was hit!");
        return customerBusinessService.viewBookings(customerId);
    }
    @GET
    @Path("/{customerId}/notifications")
    public List<Notification> viewMyNotifications(@PathParam("customerId") int customerId) {
        System.out.println("GET /customer/" + customerId + "/notifications endpoint was hit!");
        return customerBusinessService.viewNotificationsByCustomerId(customerId);
    }
